...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2018 a las 00:05:41
...
SELECT s.*,t.nombre,u.usuario FROM servicios s INNER JOIN tecnicos t INNER JOIN serviciostecnicos st INNER JOIN usuarios u INNER JOIN serviciosusuarios su ON s.idServicios = st.fk_idServicios AND t.idTecnicos = t.idTecnicos AND u.idUsuarios = su.fk_idUsuarios AND su.fk_idServicios = s.idServicios WHERE 1$$
