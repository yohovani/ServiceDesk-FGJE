...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-10-2018 a las 02:47:32
...
SELECT s.*,t.nombre,u.usuario FROM servicios s INNER JOIN tecnicos t INNER JOIN serviciostecnicos st INNER JOIN usuarios u INNER JOIN serviciosusuarios su ON s.idServicios = st.fk_idServicios AND t.idTecnicos = st.fk_idTecnicos AND u.idUsuarios = su.fk_idUsuarios AND su.fk_idServicios = s.idServicios WHERE 1 ORDER BY s.idServicios$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectServicosExcelFechas` (IN `fecha1` DATE, IN `fecha2` DATE)  READS SQL DATA
SELECT s.*,t.nombre,u.usuario FROM servicios s INNER JOIN tecnicos t INNER JOIN serviciostecnicos st INNER JOIN usuarios u INNER JOIN serviciosusuarios su ON s.idServicios = st.fk_idServicios AND t.idTecnicos = t.idTecnicos AND u.idUsuarios = su.fk_idUsuarios AND su.fk_idServicios = s.idServicios WHERE s.fecha >= fecha1 AND s.fecha_fin <= fecha2$$
...
(7, '2018-10-10', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 'Test', 'Ninguno', '1 semana', 1);
...
(31, '2018-10-10', '2018-10-10', '16:37:51', '16:42:33', 'Internet', 'gyvyt', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(32, '2018-10-10', '2018-10-10', '17:02:46', '17:32:24', 'Internet', 'test', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(33, '2018-10-10', '2018-10-10', '17:05:35', '17:32:26', 'Internet', '23', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(34, '2018-10-10', '2018-10-10', '17:17:28', '17:32:28', 'Otro', 'er', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(35, '2018-10-10', '2018-10-10', '17:20:29', '17:32:37', 'Word', 'hgf', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(36, '2018-10-10', '2018-10-10', '17:21:17', '17:32:40', 'Internet', 'gbn', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(37, '2018-10-10', '2018-10-10', '17:25:15', '17:36:29', 'Internet', 'fhgj', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(38, '2018-10-10', '2018-10-10', '17:32:44', '17:36:40', 'Internet', 'gdf', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(39, '2018-10-10', '2018-10-10', '17:33:46', '17:38:20', 'Internet', 'test en tiempo real', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(40, '2018-10-10', '2018-10-10', '17:35:20', '17:38:56', 'Internet', 'rsdf', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(41, '2018-10-10', '2018-10-10', '17:36:21', '17:38:18', 'Internet', 'sad', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(42, '2018-10-10', '2018-10-10', '17:38:25', '17:40:05', 'Internet', 'sds', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(43, '2018-10-10', '2018-10-10', '17:39:01', '17:40:04', 'Internet', 'sda', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(44, '2018-10-10', '2018-10-10', '17:42:31', '17:43:17', 'Internet', 'fsd', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(45, '2018-10-10', '2018-10-10', '17:49:36', '17:56:47', 'Internet', '132', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1),
(46, '2018-10-10', '2018-10-10', '17:50:28', '17:56:36', 'Internet', 'tret', 'DEPARTAMENTO DE RECURSOS FINANCIEROS', 1);
...
--
ALTER TABLE `servicios`
  MODIFY `idServicios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
